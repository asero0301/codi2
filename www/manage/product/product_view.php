 ...
 * file   : /coditop/manage/product/product_view.php
 * date   : 2008.08.28
 * desc   : Admin product view
 *******************************************************/
session_start();
...
function idCheck(id) {
	window.open('/pop/pop_id_check.php?mem_id='+id, 'pop_id_check', 'width=300, height=150, status=no');
}

function zipCheck(kind) {
	window.open('/pop/pop_post.php?kind='+kind, 'pop_post', 'width=300, height=350, status=no');
}
/*
function img_filetype_view() {
	if(document.frm.shop_logo.value.match(/(.jpg|.jpeg|.gif|.png|.bmp|.pdf)$/)) {
		document.getElementById('view_shop_logo').src = document.frm.shop_logo.value;
...
<table width="980" border="0" cellpadding="3" cellspacing="1" bgcolor="#CECECE">
	...
	<tr> 
		...
		<td bgcolor="#FFFFFF">
			...
			<input type="button" value="중복확인" onClick="idCheck(document.frm.mem_id.value);">
		</td>
		<td width="100" align="right" bgcolor="#EFEFEF"><font color="#666666"><b> 비밀번호&nbsp; </b></font></td>
		<td bgcolor="#FFFFFF">
			<font color="#666666"><strong><input type="password" id="mem_pwd" name="mem_pwd" value="<?=$mem_pwd?>"></strong></font>
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td bgcolor="#FFFFFF" colspan="3">
			...
			<input type="button" value="우편번호 찾기" onClick="zipCheck('M');">
		</td>
	</tr>
	<tr> 
...
<table width="980" border="0" cellpadding="3" cellspacing="1" bgcolor="#CECECE">
	...
	<tr> 
		...
		<td bgcolor="#FFFFFF" colspan="3">
			...
			<input type="button" value="우편번호 찾기" onClick="zipCheck('S');">
		</td>
	</tr>
	<tr> 
		<td width="100" align="right" bgcolor="#EFEFEF"><font color="#666666"><b> 주소1&nbsp; </b></font></td>
