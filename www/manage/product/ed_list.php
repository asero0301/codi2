 ...
 * file   : /coditop/manage/product/ed_list.php
 * date   : 2008.08.20
 * desc   : Admin ed list
...
$cond = " where 1 and A.p_idx = B.p_idx and ( now() > B.end_dt ) ";
if ( $key != "" ) {
...
$cond = "";
$cond = " where 1 AND A.shop_idx = B.shop_idx AND A.p_idx = C.p_idx AND ( now() > C.end_dt ) ";
$orderby = " ORDER BY A.p_reg_dt DESC ";
if ( $key != "" ) {
	$cond .= " and $key like '%$kwd%' ";
}
...
while ( $row = $mainconn->fetch($res) ) {
	...
	$LIST .= "
		<tr>
		  ...
		  <td align='center'  bgcolor='#FFFFFF'class='stext'>$end_dt</td>
		  ...
		  <td align='center' bgcolor='#FFFFFF'class='stext'>
			...
			<input type='button' value='삭제' onClick='delProduct(\"$p_idx\");'>
		  </td>
		</tr>
		<tr>
...
<table width="980" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td width="50%" height="23"><b><font color="#333333">■ 평가완료된 코디</font></b>  </td>
              ...
              <tr>
                <td align="center" bgcolor="EFEFEF" style="padding:12 25 12 25"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="150" align="center" class="stextbold"><font color="#000000"><b>마감일</b></font></td>
