...
while ( $row = $mainconn->fetch($res) ) {
	...
	$banner_status_str = ( $banner_status == "Y" ) ? "적용" : "미적용";
	$btn_str = ( $banner_status == "Y" ) ? "미적용" : "적용";
	...
	$LIST .= "
		<tr>
		  ...
		  <td align='center' bgcolor='#FFFFFF'class='stext'>
			<input type='button' value='수정' onClick='editContent(\"$banner_idx\");'>
...
<table width="980" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td width="50%" height="23"><b><font color="#333333">■ 배너관리</font></b>  </td>
              ...
              <tr>
                <td align="center" bgcolor="EFEFEF" style="padding:12 25 12 25"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="200" align="center" class="stextbold"><font color="#000000"><b>배너</b></font></td>
              ...
              <tr>
				...
				<td width="120" style="padding-top:1">
					<select id="key" name="key" class="goodcss">
						...
						<option value="banner_title" <? if ( $key == "banner_title" ) echo " selected"; ?>>제목</option>
						<option value="banner_content" <? if ( $key == "banner_content" ) echo " selected"; ?>>내용</option>
					</select>
				</td>
