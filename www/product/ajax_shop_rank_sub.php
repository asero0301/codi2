 ...
 * file   : /coditop/product/ajax_shop_rank_sub.php
 * date   : 2009.01.15
 * desc   : 베스트샵 순위 ajax 처리
 *
 ...
 * 로직은 /proc/make_shop_rank.php와 동일하지만 $term, $key, $kwd 값이 수시로 변할 수 있다고 가정한다.
...
<table width='645' border='0' cellspacing='0' cellpadding='0'>
	<tr>
		...
		<td width='130'><a href='#' onClick=\"loadShopRankSub('monthly','$this_m_first','$key','$kwd');\"  onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image55','','/img/tap_codi_ov_02.gif',1);\"><img src='/img/{$term_tab_2}' name='Image55' width='131' height='30' border='0' id='Image55' /></a></td>
...
if ( $term ) {
	...
	if ( $row ) {
		...
		$noterm_cond = " and A.shop_idx = B.shop_idx and A.shop_status = 'Y' and B.rs_start_dt = '$t_rs_start_dt' and B.rs_end_dt = '$t_rs_end_dt' ";
