 ...
 * file   : /coditop/proc/make_auth_rank_list.php
 * date   : 2009.01.15
 * desc   : 인증샵 리스트 html 생성
 *
 * 이 페이지는 페이지의 DB로딩을 줄이기 위한 html을 생성하기 위한 모듈이다.
 * 초기로딩시 이 모듈을 호출하고 그 다음부터는 ajax 모듈(/product/ajax_auth_rank_list.php)에서 처리.
 *******************************************************/
...
$str = "
      <table width='645' border='0' cellspacing='0' cellpadding='0'>
        <tr>
          <td width='129'><a href='#' onClick=\"loadAuthShopList('default','','','1','');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image23','','/img/tap_shop_ov_01.gif',1);\"><img src='/img/{$tab_img_1}' width='190' name='Image23' height='30' border='0' id='Image23' /></a></td>
		  <td width='130'><a href='#' onClick=\"loadAuthShopList('stat','','','1','');\" onmouseout='MM_swapImgRestore()' onmouseover=\"MM_swapImage('Image24','','/img/tap_shop_ov_02.gif',1);\"><img src='/img/{$tab_img_2}' name='Image24' width='190' height='30' border='0' id='Image24' /></a></td>
